...
def draw_buttons(img):
    ...
    cv2.putText(img, "CLEAR ALL", (49,33), cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,255),2)
    cv2.putText(img, "BLUE", (185,33), cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,255),2)
    cv2.putText(img, "GREEN", (298,33), cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,255),2)
    cv2.putText(img, "RED", (420,33), cv2.FONT_HERSHEY_SIMPLEX,0.5,(255,255,255),2)
    cv2.putText(img, "YELLOW", (520,33), cv2.FONT_HERSHEY_SIMPLEX,0.5,(150,150,150),2)
    return img
...
while True:
    ...
    paintWindow = draw_buttons(paintWindow)
    ...
    if len(cnts) > 0:
        ...
        if center[1] <= 65:
            if 40 <= center[0] <= 140:
                ...
                # Reset all points (VERY IMPORTANT)
                bpoints = [deque(maxlen=1024)]
                gpoints = [deque(maxlen=1024)]
                rpoints = [deque(maxlen=1024)]
                ypoints = [deque(maxlen=1024)]
